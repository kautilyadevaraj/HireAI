        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p>
                  Total number of outreach messages sent across all campaigns
                </p>
              </TooltipContent>
            </Tooltip>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p>
                  Percentage of candidates who replied to your outreach messages
                </p>
              </TooltipContent>
            </Tooltip>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p>Number of interviews scheduled from outreach campaigns</p>
              </TooltipContent>
            </Tooltip>
          </CardHeader>
          <CardContent>
