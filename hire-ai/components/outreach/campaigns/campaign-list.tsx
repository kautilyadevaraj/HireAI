                ...
                <div className="space-y-2 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p>Campaign performance metrics and status</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  ...
                  <div className="text-right space-y-1">
                    <div className="flex gap-4 text-sm">
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>Total messages sent in this campaign</p>
                        </TooltipContent>
                      </Tooltip>
                      <Tooltip>
                        <TooltipTrigger asChild>
                        ...
                        <TooltipContent>
                          <p>Messages that were opened by candidates</p>
                        </TooltipContent>
                      </Tooltip>
                      <Tooltip>
                        <TooltipTrigger asChild>
                        ...
                        <TooltipContent>
                          <p>Candidates who responded to your message</p>
                        </TooltipContent>
                      </Tooltip>
                      <Tooltip>
                        <TooltipTrigger asChild>
                        ...
                        <TooltipContent>
                          <p>Interviews scheduled from this campaign</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
