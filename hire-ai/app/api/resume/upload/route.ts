...
export async function POST(request: NextRequest) {
    try {
      ...
      `;
            ...
            extractedText =
                "Error: Could not extract text from the document. Please try again or upload a different file.";
        }
        ...
        `;
                ...
                const analyzeResult =
                    await analyzeModel.generateContent(analyzePrompt);
