...
export default function ResumeParserPage() {
    ...
    const [selectedResume, setSelectedResume] = useState<UploadedResume | null>(
        null,
    );
        ...
        try {
            ...
            if (resume.filename && resume.status === "completed") {
                const response = await fetch(
                    `/api/resume/delete?filename=${encodeURIComponent(resume.filename)}`,
                    {
                        method: "DELETE",
                    },
                );
        ...
        <div className="space-y-8">
            ...
            >
                ...
                <p className="text-muted-foreground/80">
                    Upload resumes to automatically extract and structure
                    candidate information using AI.
                </p>
            </div>
                    ...
                    >
                        <CardHeader>
                            ...
                            <CardDescription className="text-muted-foreground/70">
                                Drag and drop PDF or Word documents, or click to
                                browse
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                        ...
                        <CardContent>
                            {!selectedResume ? (
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-sm text-muted-foreground/50">
                                        Upload and process a resume to view
                                        structured data
                                    </p>
                                </div>
                                ...
                                <>
                                            ...
                                            <div>
                                                ...
                                                {selectedResume.structuredData
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {selectedResume.structuredData.skills.map(
                                                            (skill, index) => (
                                                                <Badge
                                                                    key={index}
                                                                    variant="secondary"
                                            ...
                                            <div className="space-y-6">
                                                {selectedResume.structuredData
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="space-y-3">
                                                            {selectedResume.structuredData.education.map(
                                                                (
                                                                    edu,
                                                                    index,
                                                                ) => (
                                                                    <div
                                                                        ...
                                                                        className="text-sm border-l-2 border-primary/20 pl-4 py-2"
                                                                    >
                                                ...
                                                {selectedResume.structuredData
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="space-y-4">
                                                            {selectedResume.structuredData.workHistory.map(
                                                                (
                                                                    job,
                                                                    index,
                                                                ) => (
                                    ...
                                    <div className="flex gap-3 pt-6 border-t border-border/30">
                                        ...
                                        <Button
                                            ...
                                            onClick={() =>
                                                removeResume(selectedResume.id)
                                            }
                                        >
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-sm text-muted-foreground/50">
                                        Unable to extract structured data from
                                        this resume
                                    </p>
                                </div>
                            )}
