  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground/80">Welcome back! Here's what's happening with your hiring pipeline.</p>
      </div>
              ...
              {recentActivity.map((activity, index) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground/60">{activity.candidate}</p>
                  </div>
                  <div className="flex-shrink-0 text-sm text-muted-foreground/50">{activity.time}</div>
                </div>
              ))}
            </div>
          </CardContent>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground/60">{candidate.title}</p>
                    </div>
                    <Badge 
                      variant="secondary" 
                  ...
                  <p className="text-xs text-muted-foreground/50">{candidate.location}</p>
                </div>
              ))}
            </div>
          </CardContent>
